...
export const MOCK_EVENT_TYPES = [
  { name: 'contact.created', display_name: 'Contact Created', category: 'crm', is_built_in: true },
  { name: 'workflow.completed', display_name: 'Workflow Completed', category: 'workflows', is_built_in: true },
  { name: 'agent.error', display_name: 'Agent Error', category: 'agents', is_built_in: true },
]
