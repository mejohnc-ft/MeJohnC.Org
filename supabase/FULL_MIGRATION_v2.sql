-- ============================================
-- FULL MIGRATION v2 - Safe for re-runs
...
VALUES ('Sales Pipeline', 'sales', 'Default sales pipeline', true)
...
INSERT INTO news_categories (slug, name, description, color, order_index) VALUES
  ('ai-research', 'AI Research', 'Academic papers and research', 'blue', 0),
  ('industry', 'Industry News', 'Business developments', 'green', 1),
  ('tools', 'Tools & Libraries', 'New tools and frameworks', 'purple', 2)
ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO task_projects (name, slug, description, color) VALUES
  ('Personal', 'personal', 'Personal tasks', 'blue'),
  ('Work', 'work', 'Work tasks', 'green')
ON CONFLICT (slug) DO NOTHING;
