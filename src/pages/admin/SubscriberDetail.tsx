...
import { ArrowLeft, Save, Trash2, Mail, MousePointerClick, Eye } from 'lucide-react';
...
const SubscriberDetail = () => {
  ...
  useSEO({ title: isNew ? 'Add Subscriber' : 'Edit Subscriber', noIndex: true });
  ...
  const toggleList = (listId: string) => {
    if (formData.lists.includes(listId)) {
      setFormData({ ...formData, lists: formData.lists.filter((l) => l !== listId) });
    } else {
      ...
      <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-card border border-border rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{subscriber.total_emails_sent}</p>
                </div>
              </div>
            </div>
            <div className="bg-card border border-border rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{subscriber.total_emails_opened}</p>
                </div>
              </div>
            </div>
            <div className="bg-card border border-border rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold">{subscriber.total_emails_clicked}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-lg p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, status: e.target.value as EmailSubscriber['status'] })}
          ...
          <div className="space-y-4">
            ...
            {lists.length === 0 && (
              <p className="text-sm text-muted-foreground">No lists available. Create lists first.</p>
            )}
          </div>
