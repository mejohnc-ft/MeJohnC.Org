...
const API_REGISTRY: ApiEntry[] = [
  // Outbound APIs
  {
    ...
    name: "Supabase",
    description:
      "PostgreSQL database with real-time subscriptions, auth, and REST/GraphQL APIs",
    direction: "outbound",
    category: "database",
    authType: "anon-key",
  ...
  },
  {
    ...
    name: "Clerk",
    description:
      "Authentication and user management with social logins and session handling",
    direction: "outbound",
    category: "auth",
  ...
  },
  {
    ...
    name: "Ghost CMS",
    description:
      "Headless content management system for blog posts and publications",
    direction: "outbound",
    category: "cms",
    authType: "api-key",
    baseUrl: null,
  ...
  },
  {
    ...
    description:
      "AI language model API for content generation, analysis, and intelligent features",
    direction: "outbound",
    category: "ai",
    authType: "api-key",
  ...
  },
  {
    ...
    name: "Figma",
    description:
      "Design platform API for accessing design tokens, components, and assets",
    direction: "outbound",
    category: "design",
  ...
  },
  {
    ...
    name: "GitHub",
    description:
      "Source code hosting and CI/CD via GitHub Actions for automated deployments",
    direction: "outbound",
    category: "devops",
    authType: "personal-access-token",
  ...
  },
  {
    ...
    description:
      "Web analytics for tracking page views, user behavior, and engagement metrics",
    direction: "outbound",
    category: "analytics",
  ...
  },
  {
    ...
    description:
      "Transactional email delivery for notifications, campaigns, and user communications",
    direction: "outbound",
    category: "email",
    authType: "api-key",
  ...
  },
  {
    ...
    name: "Sentry",
    description:
      "Error monitoring and performance tracking with real-time alerting",
    direction: "outbound",
    category: "monitoring",
    authType: "dsn",
  ...
  },
  {
    ...
    name: "NewsAPI",
    description:
      "News aggregation API for fetching headlines and articles from various sources",
    direction: "outbound",
    category: "news",
    authType: "api-key",
  ...
  // Inbound APIs (edge functions)
  {
    ...
    name: "health-check",
    description:
      "Health check endpoint returning service status and uptime information",
    direction: "inbound",
  ...
  },
  {
    ...
    name: "fetch-news",
    description:
      "Serverless function that fetches and caches news articles from external sources",
    direction: "inbound",
    category: "edge-function",
  ...
  },
  {
    ...
    name: "metrics-sync",
    description:
      "Scheduled function that syncs analytics and performance metrics to the database",
    direction: "inbound",
    category: "edge-function",
    authType: "service-key",
  ...
  },
  {
    ...
    description:
      "Webhook receiver for external metrics and monitoring service callbacks",
    direction: "inbound",
    category: "edge-function",
...
const ApiRegistry = () => {
  ...
  const outboundApis = filteredApis.filter(
    (api) => api.direction === "outbound",
  );
  ...
  const totalOutbound = API_REGISTRY.filter(
    (api) => api.direction === "outbound",
  ).length;
  const totalInbound = API_REGISTRY.filter(
    (api) => api.direction === "inbound",
  ).length;
      ...
      >
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            All APIs consumed and exposed by this application
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-card border border-border rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-emerald-400">
              {totalConfigured}/{API_REGISTRY.length}
            </div>
