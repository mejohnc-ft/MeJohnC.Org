      ...
      if (isLoading) {
        setMessages((prev) => [
          ...prev,
          {
            id: generateId(),
            role: 'assistant',
            content: 'Response timeout. The server agent may be unavailable. Try switching to API mode or check the server status.',
            timestamp: new Date(),
          },
        ]);
        setIsLoading(false);
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-1">
                {chatSessions.length === 0 ? (
                  <p className="text-sm text-muted-foreground p-2">No past conversations</p>
                ) : (
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center justify-between p-4 border-b border-border bg-card/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-foreground">AI Manager</h1>
                ...
                <div className="p-4 space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Required for Direct API mode. Your key is stored locally in your browser.
                    </p>
                  </div>
                  <div className="flex items-start gap-2 p-3 bg-blue-500/10 rounded-lg">
                    <AlertCircle className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                    <div className="text-sm">
                      <p className="font-medium text-blue-500">Backend Modes:</p>
                      <ul className="text-muted-foreground mt-1 space-y-1">
                        <li><strong>Server:</strong> Uses VPS/HomeServer agent with file access, git, and tools</li>
                        <li><strong>API:</strong> Direct Claude API calls - faster but no tool access</li>
                      </ul>
                    </div>
                  </div>
                </div>
