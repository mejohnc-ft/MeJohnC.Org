...
interface InfraModalProps {
  ...
  onClose: () => void;
  onSave: (
    data: InfraNodeCreate | ({ id: string } & Partial<InfraNode>),
  ) => Promise<void>;
...
function InfraModal({
  ...
  useEffect(() => {
    if (node) {
      ...
      setMonthlyCost(
        node.monthly_cost !== null ? String(node.monthly_cost) : "",
      );
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="Netlify Production"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                placeholder="hosting, production, cdn"
              />
            </div>

            <div>
              <label className="text-sm font-medium text-foreground block mb-1">
                Config Notes (markdown)
              </label>
              <textarea
                value={configNotes}
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-lg font-medium text-foreground mb-1">
              No infrastructure nodes yet
            </h3>
            <p className="text-muted-foreground mb-4">
              Map your first infrastructure node to get started.
            </p>
            <Button onClick={openNew}>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge
                        className={`text-[10px] ${statusColors[node.status] ?? ""}`}
                      >
                        {node.status}
                      </Badge>
