...
const Education = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-800 via-gray-900 to-purple-900 relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-20 w-32 h-32 border-2 border-blue-400 rounded-lg rotate-12"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 border-2 border-purple-400 rounded-full"></div>
        <div className="absolute top-1/2 right-1/4 w-24 h-24 border-2 border-green-400 rounded-lg rotate-45"></div>
      </div>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-8 border border-gray-600/50 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="bg-gray-700/80 backdrop-blur-sm rounded-xl p-6 border border-gray-600/50">
                  ...
                  <p className="text-gray-300 mb-3">University of Maine</p>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-600/50">
                    <h5 className="font-semibold text-gray-200 mb-2">Relevant Coursework</h5>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-600/50">
                    <h5 className="font-semibold text-gray-200 mb-2">Academic Focus</h5>
            ...
            <div className="relative bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl p-8 border border-gray-600/50 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-3">
                {certifications.map((cert, index) => (
                  <div key={index} className="bg-gray-700/80 backdrop-blur-sm p-4 rounded-xl border border-gray-600/50 hover:shadow-md transition-all duration-300 group/cert">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-300">{cert.category}</div>
                      </div>
                    </div>
                  </div>
                ))}
