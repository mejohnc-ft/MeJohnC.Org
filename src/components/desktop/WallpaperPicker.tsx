...
import { useWorkspaceContext, useWindowManagerContext } from "./WindowManager";
...
const PRESET_WALLPAPERS = [
  ...
  {
    name: "Midnight",
    value: "linear-gradient(135deg, #0c0c0c 0%, #1a1a2e 50%, #2d1b69 100%)",
  },
  {
    name: "Ocean",
    value:
      "linear-gradient(135deg, #0d1b2a 0%, #1b2838 30%, #1b4965 60%, #5fa8d3 100%)",
  },
  {
    name: "Aurora",
    value:
      "linear-gradient(135deg, #0f0c29 0%, #302b63 40%, #24243e 70%, #0f9b8e 100%)",
  },
  {
    name: "Ember",
    value:
      "linear-gradient(135deg, #1a0a0a 0%, #2d1f1f 30%, #6b2d3e 60%, #d4556b 100%)",
  },
  {
    name: "Forest",
    value:
      "linear-gradient(135deg, #0a1a0a 0%, #1a2e1a 30%, #2d4a2d 60%, #4a7c59 100%)",
  },
  {
    name: "Slate",
    value:
      "linear-gradient(135deg, #1e1e2e 0%, #2b2b3d 30%, #3d3d56 60%, #525270 100%)",
  },
  {
    name: "Dusk",
    value:
      "linear-gradient(135deg, #141e30 0%, #243b55 40%, #4a3f6b 70%, #8b5e83 100%)",
  },
  {
    name: "Void",
    value:
  ...
  },
  {
    name: "Nebula",
    value:
      "linear-gradient(135deg, #1f1c2c 0%, #353074 30%, #6c4ab6 60%, #8e44ad 100%)",
  },
  // Light presets
  {
    name: "Morning",
    value: "linear-gradient(135deg, #fdfcfb 0%, #e2d1c3 50%, #f5e6d3 100%)",
  },
  {
    name: "Sky",
    value: "linear-gradient(135deg, #e0eafc 0%, #cfdef3 40%, #a8c0ff 100%)",
  },
  {
    name: "Peach",
  ...
  {
    name: "Mint",
    value: "linear-gradient(135deg, #e6fffa 0%, #b2f5ea 40%, #81e6d9 100%)",
  },
  {
    name: "Cloud",
    value:
      "linear-gradient(135deg, #f5f7fa 0%, #e4e9f0 30%, #c3cfe2 60%, #dfe6ed 100%)",
  },
];

export default function WallpaperPicker() {
  const workspace = useWorkspaceContext();
  const { state, closeWindow } = useWindowManagerContext();
  const [selected, setSelected] = useState(workspace.wallpaper);
  const [customUrl, setCustomUrl] = useState("");

  const handleApply = () => {
    workspace.updateWallpaper(selected);
    const pickerWindow = state.windows.find(
      (w) => w.appId === "wallpaper-picker",
    );
    if (pickerWindow) {
      closeWindow(pickerWindow.id);
    }
  };
