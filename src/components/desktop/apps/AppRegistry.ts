...
const apps: DesktopApp[] = [
  ...
  },
  {
    ...
    category: 'content',
    component: () => import('@/pages/admin/news/index').catch(() => ({ default: () => null })),
  ...
  // Management
  {
    ...
    category: 'management',
    component: () => import('@/pages/admin/tasks/index').catch(() => ({ default: () => null })),
    defaultSize: { width: 850, height: 600 },
  ...
  },
  {
    ...
    color: 'text-blue-400',
    category: 'management',
    component: () => import('@/pages/admin/crm/index').catch(() => ({ default: () => null })),
    defaultSize: { width: 900, height: 650 },
    minSize: { width: 600, height: 400 },
    singleton: true,
    defaultDockPinned: false,
  ...
  },
  {
    ...
    category: 'management',
    component: () => import('@/pages/admin/metrics/index').catch(() => ({ default: () => null })),
    defaultSize: { width: 900, height: 650 },
    minSize: { width: 600, height: 400 },
    singleton: true,
    defaultDockPinned: false,
