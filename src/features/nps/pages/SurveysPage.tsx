 ...
 * NPS Surveys Page
 *
 * Main page for managing NPS surveys.
 *
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <Button asChild>
                <Link to="/admin/nps/surveys/new">Create Survey</Link>
              </Button>
            </div>
          ) : (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <Link to={`/admin/nps/surveys/${survey.id}`}>View Details</Link>
                  </Button>
                </div>
